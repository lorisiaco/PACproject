...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{amount} (double) - Valore budget.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \texttt{username} (String) - Username utente.
        \item \texttt{amount} (double) - Valore da aggiungere al budget.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \texttt{username} (String) - Username utente.
        \item \texttt{amount} (double) - Valore da sottrarre al budget.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Descrizione:} Permette di creare un piano di risparmio.
    \item \textbf{Parametri:}
    \begin{itemize}
        \item \texttt{username} (String) - Username utente.
        \item \texttt{name} (String) - Nome del piano di risparmio.
        \item \texttt{amount} (double) - Valore del piano di risparmio.
    \end{itemize}
\end{itemize}
...
\begin{figure}[H]
    ...
    \caption{API per creare un piano di risparmio}
